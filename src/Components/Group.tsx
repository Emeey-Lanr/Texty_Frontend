...
const Group = () => {
    const {groupChatOrPrivateChatOpening, setGroupChatOrPrivateChatOpening, showGroupModal} =useContext(appContext)
    return (
        <>
            {groupChatOrPrivateChatOpening === 2 &&  <div className="chat-div">
        <div className="chatting_space">
          ...
          <div className="chat_input_div">
              ...
              <div className="chat_btn">
                ...
                {showGroupModal === 1 && < GroupNotification />} 
                {showGroupModal === 2 && <GroupDetails/>}
      </div>}
      </>
